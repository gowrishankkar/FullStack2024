...
const sourcePath = path.join(rootDir, "Ecommerce_Project_Report.md");
const markdown = fs.readFileSync(sourcePath, "utf8");

const tempDir = path.join(rootDir, "tmp_docx_build");
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <dc:title>Ecommerce Project Report</dc:title>
  <dc:creator>FullStack2024</dc:creator>
  <cp:lastModifiedBy>GitHub Copilot</cp:lastModifiedBy>
  <dc:description>Automatically converted from Markdown to DOCX.</dc:description>
  <cp:keywords>ecommerce, fullstack, project report</cp:keywords>
...
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">
  ...
  <TitlesOfParts>
    <vt:vector size="1" baseType="lpstr">
      <vt:lpstr>Ecommerce Project Report</vt:lpstr>
    </vt:vector>
  </TitlesOfParts>
  <Company></Company>
...
const zipOutputPath = path.join(rootDir, "Ecommerce_Project_Report_fixed.zip");
const docxOutputPath = path.join(rootDir, "Ecommerce_Project_Report.docx");
